/**
 * SubscriptionPastDueEmail — envoyé quand l'événement Stripe
 * `invoice.payment_failed` est reçu par le webhook.
 *
...
export default function SubscriptionPastDueEmail({ merchantName, portalUrl }: SubscriptionPastDueEmailProps) {
  return (
    <div style={container}>
      <div style={header}>
      ...
      <div style={content}>
        ...
        <p style={{ fontSize: '16px', lineHeight: '1.6' }}>
          Votre paiement mensuel Souqly n&apos;a pas pu être traité. Votre catalogue est temporairement suspendu.
        </p>
        ...
        <p style={{ fontSize: '14px', lineHeight: '1.6', color: '#6b7280' }}>
          Si vous ne mettez pas à jour vos informations de paiement, votre compte sera annulé.
        </p>
